...
impl<'d, SPI, /*XRST,*/ XCS, XDCS, DREQ> VS1053<'d, SPI, /*XRST, */ XCS, XDCS, DREQ>
where
    SPI: SpiDevice,
    //XRST: OutputPin,
    XCS: OutputPin,
    ...
    DREQ: InputPin,
{
    ...
    fn _read_register(&mut self, _address: u8) -> Result<u16, SPI: Error> {
        Ok(0)
    }
    ...
    fn _wram_read(&mut self, _address: u16) -> Result<u16, SPI: Error> {
        Ok(0)
    }
