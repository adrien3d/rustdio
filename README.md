...
[](https://docs.espressif.com/projects/esp-idf/en/v5.3/esp32c6/api-guides/partition-tables.html)
...
cd esp-idf-tea5767
idf.py set-target {esp32/esp32s2/esp32c6/esp32c2/esp32c3/esp32c6}
idf.py menuconfig
idf.py flash
```
